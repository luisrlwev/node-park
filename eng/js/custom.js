	...
	jQuery(document).on('submit', 'form.cons-contact-form', function(e){
		...
		jQuery.ajax({
			...
			success:function(data){
				...
				if(data=="1"){
				jQuery("<div class='alert alert-success'>Message sent succesfully</div>").insertBefore('form.cons-contact-form');
				}else{
				jQuery("<div class='alert alert-danger'>There was a problem try again</div>").insertBefore('form.cons-contact-form');
				}
			}
		});

...
if ( ! function_exists( 'aarhus_select_fonts_options_map' ) ) {
	/**
	 * Font options page
	 */
	function aarhus_select_fonts_options_map() {
		
		aarhus_select_add_admin_page(
			array(
				'slug'  => '_fonts_page',
				'title' => esc_html__( 'Fonts', 'aarhus' ),
				'icon'  => 'fa fa-font'
			)
		);
		 ...
		 * Headings
		 */
		$panel_headings = aarhus_select_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_headings',
				'title' => esc_html__( 'Headings', 'aarhus' )
			)
		);
		
		//H1
		$group_heading_h1 = aarhus_select_add_admin_group(
			array(
				'name'        => 'group_heading_h1',
				'title'       => esc_html__( 'H1 Style', 'aarhus' ),
				'description' => esc_html__( 'Define styles for h1 heading', 'aarhus' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h1_1 = aarhus_select_add_admin_row(
			array(
		...
		aarhus_select_add_admin_field(
			array(
				...
				'args'          => array(
					'suffix' => esc_html__( 'px / em', 'aarhus' )
				),
				'parent'        => $row_heading_h1_1
			)
		);
		...
		$row_heading_h1_2 = aarhus_select_add_admin_row(
			array(
		...
		$row_heading_h1_3 = aarhus_select_add_admin_row(
			array(
		...
		aarhus_select_add_admin_field(
			array(
				...
				'name'          => 'h1_margin_top',
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top (px)', 'aarhus' ),
		...
		aarhus_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom (px)', 'aarhus' ),
				'parent'        => $row_heading_h1_3
			)
		);
		
		//H2
		$group_heading_h2 = aarhus_select_add_admin_group(
			array(
				'name'        => 'group_heading_h2',
				'title'       => esc_html__( 'H2 Style', 'aarhus' ),
				'description' => esc_html__( 'Define styles for h2 heading', 'aarhus' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h2_1 = aarhus_select_add_admin_row(
			array(
		...
		$row_heading_h2_2 = aarhus_select_add_admin_row(
			array(
		...
		$row_heading_h2_3 = aarhus_select_add_admin_row(
			array(
		...
		//H3
		$group_heading_h3 = aarhus_select_add_admin_group(
			array(
				'name'        => 'group_heading_h3',
				'title'       => esc_html__( 'H3 Style', 'aarhus' ),
				'description' => esc_html__( 'Define styles for h3 heading', 'aarhus' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h3_1 = aarhus_select_add_admin_row(
			array(
		...
		$row_heading_h3_2 = aarhus_select_add_admin_row(
			array(
		...
		$row_heading_h3_3 = aarhus_select_add_admin_row(
			array(
		...
		//H4
		$group_heading_h4 = aarhus_select_add_admin_group(
			array(
				'name'        => 'group_heading_h4',
				'title'       => esc_html__( 'H4 Style', 'aarhus' ),
				'description' => esc_html__( 'Define styles for h4 heading', 'aarhus' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h4_1 = aarhus_select_add_admin_row(
			array(
		...
		$row_heading_h4_2 = aarhus_select_add_admin_row(
			array(
		...
		$row_heading_h4_3 = aarhus_select_add_admin_row(
			array(
		...
		//H5
		$group_heading_h5 = aarhus_select_add_admin_group(
			array(
				'name'        => 'group_heading_h5',
				'title'       => esc_html__( 'H5 Style', 'aarhus' ),
				'description' => esc_html__( 'Define styles for h5 heading', 'aarhus' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h5_1 = aarhus_select_add_admin_row(
			array(
		...
		$row_heading_h5_2 = aarhus_select_add_admin_row(
			array(
		...
		$row_heading_h5_3 = aarhus_select_add_admin_row(
			array(
		...
		//H6
		$group_heading_h6 = aarhus_select_add_admin_group(
			array(
				'name'        => 'group_heading_h6',
				'title'       => esc_html__( 'H6 Style', 'aarhus' ),
				'description' => esc_html__( 'Define styles for h6 heading', 'aarhus' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h6_1 = aarhus_select_add_admin_row(
			array(
		...
		$row_heading_h6_2 = aarhus_select_add_admin_row(
			array(
		...
		$row_heading_h6_3 = aarhus_select_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings3 = aarhus_select_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings3',
				'title' => esc_html__( 'Headings Responsive (Tablet Landscape View)', 'aarhus' )
			)
		);
		
		//H1
		$group_responsive3_heading_h1 = aarhus_select_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h1',
				'title'       => esc_html__( 'H1 Responsive Style', 'aarhus' ),
				'description' => esc_html__( 'Define responsive styles for h1 heading', 'aarhus' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h1_3 = aarhus_select_add_admin_row(
			array(
		...
		//H2
		$group_responsive3_heading_h2 = aarhus_select_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h2',
				'title'       => esc_html__( 'H2 Responsive Style', 'aarhus' ),
				'description' => esc_html__( 'Define responsive styles for h2 heading', 'aarhus' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h2_3 = aarhus_select_add_admin_row(
			array(
		...
		//H3
		$group_responsive3_heading_h3 = aarhus_select_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h3',
				'title'       => esc_html__( 'H3 Responsive Style', 'aarhus' ),
				'description' => esc_html__( 'Define responsive styles for h3 heading', 'aarhus' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h3_3 = aarhus_select_add_admin_row(
			array(
		...
		//H4
		$group_responsive3_heading_h4 = aarhus_select_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h4',
				'title'       => esc_html__( 'H4 Responsive Style', 'aarhus' ),
				'description' => esc_html__( 'Define responsive styles for h4 heading', 'aarhus' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h4_3 = aarhus_select_add_admin_row(
			array(
		...
		//H5
		$group_responsive3_heading_h5 = aarhus_select_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h5',
				'title'       => esc_html__( 'H5 Responsive Style', 'aarhus' ),
				'description' => esc_html__( 'Define responsive styles for h5 heading', 'aarhus' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h5_3 = aarhus_select_add_admin_row(
			array(
		...
		//H6
		$group_responsive3_heading_h6 = aarhus_select_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h6',
				'title'       => esc_html__( 'H6 Responsive Style', 'aarhus' ),
				'description' => esc_html__( 'Define responsive styles for h6 heading', 'aarhus' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h6_3 = aarhus_select_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings = aarhus_select_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings',
				'title' => esc_html__( 'Headings Responsive (Tablet Portrait View)', 'aarhus' )
			)
		);
		
		//H1
		$group_responsive_heading_h1 = aarhus_select_add_admin_group(
			array(
		...
		$row_responsive_heading_h1_1 = aarhus_select_add_admin_row(
			array(
		...
		//H2
		$group_responsive_heading_h2 = aarhus_select_add_admin_group(
			array(
		...
		$row_responsive_heading_h2_1 = aarhus_select_add_admin_row(
			array(
		...
		//H3
		$group_responsive_heading_h3 = aarhus_select_add_admin_group(
			array(
		...
		$row_responsive_heading_h3_1 = aarhus_select_add_admin_row(
			array(
		...
		//H4
		$group_responsive_heading_h4 = aarhus_select_add_admin_group(
			array(
		...
		$row_responsive_heading_h4_1 = aarhus_select_add_admin_row(
			array(
		...
		//H5
		$group_responsive_heading_h5 = aarhus_select_add_admin_group(
			array(
		...
		$row_responsive_heading_h5_1 = aarhus_select_add_admin_row(
			array(
		...
		//H6
		$group_responsive_heading_h6 = aarhus_select_add_admin_group(
			array(
		...
		$row_responsive_heading_h6_1 = aarhus_select_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings2 = aarhus_select_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings2',
				'title' => esc_html__( 'Headings Responsive (Mobile Devices)', 'aarhus' )
			)
		);
		
		//H1
		$group_responsive2_heading_h1 = aarhus_select_add_admin_group(
			array(
		...
		$row_responsive2_heading_h1_1 = aarhus_select_add_admin_row(
			array(
		...
		//H2
		$group_responsive2_heading_h2 = aarhus_select_add_admin_group(
			array(
		...
		$row_responsive2_heading_h2_1 = aarhus_select_add_admin_row(
			array(
		...
		//H3
		$group_responsive2_heading_h3 = aarhus_select_add_admin_group(
			array(
		...
		$row_responsive2_heading_h3_1 = aarhus_select_add_admin_row(
			array(
		...
		//H4
		$group_responsive2_heading_h4 = aarhus_select_add_admin_group(
			array(
		...
		$row_responsive2_heading_h4_1 = aarhus_select_add_admin_row(
			array(
		...
		//H5
		$group_responsive2_heading_h5 = aarhus_select_add_admin_group(
			array(
		...
		$row_responsive2_heading_h5_1 = aarhus_select_add_admin_row(
			array(
		...
		//H6
		$group_responsive2_heading_h6 = aarhus_select_add_admin_group(
			array(
		...
		$row_responsive2_heading_h6_1 = aarhus_select_add_admin_row(
			array(
		 ...
		 * Text
		 */
		$panel_text = aarhus_select_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_text',
		...
		$group_text = aarhus_select_add_admin_group(
			array(
				'name'        => 'group_text',
				'title'       => esc_html__( 'Paragraph', 'aarhus' ),
				'description' => esc_html__( 'Define styles for paragraph text', 'aarhus' ),
				'parent'      => $panel_text
			)
		);
		
		$row_text_1 = aarhus_select_add_admin_row(
			array(
				'name'   => 'row_text_1',
				'parent' => $group_text
			)
		...
		$row_text_2 = aarhus_select_add_admin_row(
			array(
				'name'   => 'row_text_2',
				'parent' => $group_text,
				'next'   => true
		...
		$row_text_3 = aarhus_select_add_admin_row(
			array(
				'name'   => 'row_text_3',
				'parent' => $group_text,
				'next'   => true
		...
		$group_text_res1 = aarhus_select_add_admin_group(
			array(
				'name'        => 'group_text_res1',
				'title'       => esc_html__( 'Paragraph Responsive (Tablet Portrait View)', 'aarhus' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for tablet devices - portrait view', 'aarhus' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_1 = aarhus_select_add_admin_row(
			array(
				'name'   => 'row_text_1',
		...
		$group_text_res2 = aarhus_select_add_admin_group(
			array(
				'name'        => 'group_text_res2',
				'title'       => esc_html__( 'Paragraph Responsive (Mobile Devices)', 'aarhus' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for mobile devices', 'aarhus' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_2 = aarhus_select_add_admin_row(
			array(
				'name'   => 'row_res_text_2',
		...
		$group_link = aarhus_select_add_admin_group(
			array(
				'name'        => 'group_link',
				'title'       => esc_html__( 'Links', 'aarhus' ),
				'description' => esc_html__( 'Define styles for link text', 'aarhus' ),
				'parent'      => $panel_text
			)
		);
		
		$row_link_1 = aarhus_select_add_admin_row(
			array(
				'name'   => 'row_link_1',
				'parent' => $group_link
			)
		...
		aarhus_select_add_admin_field(
			array(
				...
				'name'          => 'link_color',
				'default_value' => '',
				'label'         => esc_html__( 'Link Color', 'aarhus' ),
				'parent'        => $row_link_1
			)
		);
		...
		aarhus_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover Link Color', 'aarhus' ),
				'parent'        => $row_link_1
			)
		);
		
		$row_link_2 = aarhus_select_add_admin_row(
			array(
				'name'   => 'row_link_2',
				'parent' => $group_link,
				'next'   => true
		...
		aarhus_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Link Decoration', 'aarhus' ),
				'options'       => aarhus_select_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
		...
		aarhus_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hovel Link Decoration', 'aarhus' ),
				'options'       => aarhus_select_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
	...
	add_action( 'aarhus_select_action_options_map', 'aarhus_select_fonts_options_map', aarhus_select_set_options_map_position( 'fonts' ) );
}
<div class="form-button-section clearfix">
    <div class="qodef-input-change"><?php esc_html_e('You should save your changes' , 'aarhus') ?></div>
    <div class="qodef-changes-saved"><?php esc_html_e('All your changes are successfully saved' , 'aarhus') ?></div>
        ...
        <div class="form-button-section-inner clearfix" >
            <?php if(is_array($page->layout) && count($page->layout)) { ?>
                <div class="qodef-anchors-holder">
                    <span class="qodef-page-anchors-label"><?php esc_html_e('Scroll to:' , 'aarhus') ?></span>
            ...
            <div class="qodef-form-save-holder">
                <input type="submit" class="btn btn-primary btn-sm pull-right" value="<?php esc_attr_e('Save Changes', 'aarhus'); ?>"/>
            </div>
        </div>
    </div>
</div>
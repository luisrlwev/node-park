        ...
        <div class="qodef-sp-table-cell">
            <div class="qodef-sp-inner">
	            ...
	            <?php if ( ! empty( $background_styles ) ) { ?>
		            <div class="qodef-sp-background" <?php aarhus_select_inline_style( $background_styles ); ?>></div>
	            <?php } ?>
	                ...
	                <?php if ( $enable_prevent === 'yes' ) { ?>
		                <div class="qodef-sp-prevent">
			                <div class="qodef-sp-prevent-inner">
				                ...
				                <label class="qodef-sp-prevent-label"><?php esc_html_e( 'Prevent This Pop-up', 'aarhus' ); ?></label>
			                </div>
		                </div>
	                <?php } ?>
                </div>

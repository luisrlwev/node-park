...
if ( ! function_exists('aarhus_select_breadcrumbs_title_type_options_map') ) {
	function aarhus_select_breadcrumbs_title_type_options_map($panel_typography) {
		
		aarhus_select_add_admin_section_title(
			array(
				'name'   => 'type_section_breadcrumbs',
				'title'  => esc_html__( 'Breadcrumbs', 'aarhus' ),
				'parent' => $panel_typography
			)
		);
	
		$group_page_breadcrumbs_styles = aarhus_select_add_admin_group(
			array(
				'name'        => 'group_page_breadcrumbs_styles',
				'title'       => esc_html__( 'Breadcrumbs', 'aarhus' ),
				'description' => esc_html__( 'Define styles for page breadcrumbs', 'aarhus' ),
				'parent'      => $panel_typography
			)
		);
	
			$row_page_breadcrumbs_styles_1 = aarhus_select_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_2 = aarhus_select_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_3 = aarhus_select_add_admin_row(
				array(
	...
	add_action( 'aarhus_select_action_additional_title_typography_options_map', 'aarhus_select_breadcrumbs_title_type_options_map');
}
...
class AarhusSelectClassSocialIconWidget extends AarhusSelectClassWidget {
	
	public function __construct() {
		parent::__construct(
			'qodef_social_icon_widget',
			esc_html__( 'Aarhus Social Icon Widget', 'aarhus' ),
			array( 'description' => esc_html__( 'Add social network icons to widget areas', 'aarhus' ) )
		);
		...
		$this->params = array_merge(
			array(
				array(
					'type'  	  => 'dropdown',
					'name'  	  => 'icon_text',
					'title' 	  => esc_html__( 'Display Icon or Text', 'aarhus' ),
					'description' => esc_html__( 'Choose whether you want to display social icon or text instead', 'aarhus' ),
					'options' 	  => array(
						'icon' => esc_html__( 'Icon', 'aarhus' ),
						'text' => esc_html__( 'Text', 'aarhus' )
					)
				),
				array(
					'type'        => 'textfield',
					'name'        => 'social_text',
					'title'       => esc_html__( 'Social Text', 'aarhus' ),
					'description' => esc_html__( 'Instert text which will describe desired social network', 'aarhus' )
				)
			),
			aarhus_select_icon_collections()->getSocialIconWidgetParamsArray(),
			array(
				array(
					'type'  => 'textfield',
					'name'  => 'link',
	...
	public function widget( $args, $instance ) {
		...
		?>
		<a class="qodef-social-icon-widget-holder qodef-icon-has-hover" <?php echo aarhus_select_get_inline_attr( $hover_color, 'data-hover-color' ); ?> <?php aarhus_select_inline_style( $icon_styles ) ?> href="<?php echo esc_url( $link ); ?>" target="<?php echo esc_attr( $target ); ?>">

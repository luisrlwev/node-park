...
class AarhusSelectClassContactForm7Widget extends AarhusSelectClassWidget {
	public function __construct() {
		parent::__construct(
			'qodef_contact_form_7_widget',
			esc_html__( 'Aarhus Contact Form 7 Widget', 'aarhus' ),
			array( 'description' => esc_html__( 'Add contact form 7 to widget areas', 'aarhus' ) )
		);
	...
	protected function setParams() {
		...
		$this->params = array(
			array(
				'type'  => 'textfield',
				'name'  => 'extra_class',
				'title' => esc_html__( 'Extra Class Name', 'aarhus' )
			),
			array(
				'type'  => 'textfield',
			...
			array(
				'type'    => 'dropdown',
				'name'    => 'contact_form',
				'title'   => esc_html__( 'Select Contact Form 7', 'aarhus' ),
				'options' => $contact_forms
			),
			array(
				'type'    => 'dropdown',
				'name'    => 'contact_form_style',
				'title'   => esc_html__( 'Contact Form 7 Style', 'aarhus' ),
				'options' => array(
	...
	public function widget( $args, $instance ) {
		...
		?>
		<div class="widget qodef-contact-form-7-widget <?php echo esc_attr( $extra_class ); ?>" <?php echo aarhus_select_get_inline_style( $widget_styles ); ?>>

...
class AarhusSelectClassRecentPosts extends AarhusSelectClassWidget {
	public function __construct() {
		parent::__construct(
			'qodef_recent_posts',
			esc_html__( 'Aarhus Recent Posts', 'aarhus' ),
			array( 'description' => esc_html__( 'Select recent posts that you would like to display', 'aarhus' ) )
		);
	...
	protected function setParams() {
		$post_types = apply_filters( 'aarhus_select_filter_search_post_type_widget_params_post_type', array( 'post' => esc_html__( 'Post', 'aarhus' ) ) );
		...
		$this->params = array(
			...
			array(
				'type'        => 'dropdown',
				'name'        => 'post_type',
				'title'       => esc_html__( 'Post Type', 'aarhus' ),
				'description' => esc_html__( 'Choose post type that you want to be searched for', 'aarhus' ),
				'options'     => $post_types
			),
            array(
                'type'        => 'dropdown',
	...
	public function widget( $args, $instance ) {
        ...
        $html = '<div class="widget qodef-recent-post-widget" ' . aarhus_select_get_inline_style( $widget_styles ) . '>';
        ...
        if ( $query->have_posts() ) {
            ...
            $html .= esc_html__('Sorry, there are no posts matching your criteria', 'aarhus');
        }
		...
		echo aarhus_select_get_module_part($html);
    }
}
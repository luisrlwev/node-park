...
class HeaderVerticalSliding extends HeaderType {
	...
	public function loadTemplate( $parameters = array() ) {
		$parameters['holder_class'] = aarhus_select_vertical_sliding_header_holder_class();
		$parameters['vertical_sliding_icon_class'] = aarhus_select_get_vertical_sliding_header_icon_class();
		
		$parameters = apply_filters( 'aarhus_select_filter_header_vertical_sliding_parameters', $parameters );

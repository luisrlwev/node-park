...
if ( ! function_exists( 'aarhus_select_get_hide_dep_for_header_vertical_area_meta_boxes' ) ) {
	function aarhus_select_get_hide_dep_for_header_vertical_area_meta_boxes() {
		$hide_dep_options = apply_filters( 'aarhus_select_filter_header_vertical_hide_meta_boxes', $hide_dep_options = array( '' => '' ) );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'aarhus_select_header_vertical_area_meta_options_map' ) ) {
	function aarhus_select_header_vertical_area_meta_options_map( $header_meta_box ) {
		$hide_dep_options = aarhus_select_get_hide_dep_for_header_vertical_area_meta_boxes();
		
		$header_vertical_area_meta_container = aarhus_select_add_admin_container(
			array(
		...
		aarhus_select_create_meta_box_field(
			array(
				...
				'type'          => 'yesno',
				'default_value' => 'no',
				'label'         => esc_html__( 'Disable Background Image', 'aarhus' ),
				'description'   => esc_html__( 'Enabling this option will hide background image in Vertical Menu', 'aarhus' ),
				'parent'        => $header_vertical_area_meta_container
			)
		);
		...
		aarhus_select_create_meta_box_field(
			array(
				...
				'description'   => esc_html__( 'Set shadow on vertical menu', 'aarhus' ),
				'parent'        => $header_vertical_area_meta_container,
				'default_value' => '',
		...
		$vertical_header_border_container = aarhus_select_add_admin_container(
			array(
				'type'            => 'container',
		...
		aarhus_select_create_meta_box_field(
			array(
				...
				'description' => esc_html__( 'Choose color of border', 'aarhus' ),
	...
	add_action( 'aarhus_select_action_additional_header_area_meta_boxes_map', 'aarhus_select_header_vertical_area_meta_options_map' );
}
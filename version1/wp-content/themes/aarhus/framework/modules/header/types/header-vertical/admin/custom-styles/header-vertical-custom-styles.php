...
if ( ! function_exists( 'aarhus_select_vertical_menu_styles' ) ) {
	function aarhus_select_vertical_menu_styles() {
	...
	add_action( 'aarhus_select_action_style_dynamic', 'aarhus_select_vertical_menu_styles' );
}

if ( ! function_exists( 'aarhus_select_vertical_main_menu_styles' ) ) {
	/**
	 * Generates styles for vertical main main menu
	 */
	function aarhus_select_vertical_main_menu_styles() {
		...
		if ( ! empty( $menu_top_margin ) ) {
			$menu_holder_styles['margin-top'] = aarhus_select_filter_px( $menu_top_margin ) . 'px';
		}
		if ( ! empty( $menu_bottom_margin ) ) {
			$menu_holder_styles['margin-bottom'] = aarhus_select_filter_px( $menu_bottom_margin ) . 'px';
		}
		...
		echo aarhus_select_dynamic_css( $menu_holder_selector, $menu_holder_styles );
	...
	add_action( 'aarhus_select_action_style_dynamic', 'aarhus_select_vertical_main_menu_styles' );
}
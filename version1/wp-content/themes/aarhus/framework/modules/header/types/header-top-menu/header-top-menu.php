...
class HeaderTopMenu extends HeaderType {
	...
	public function __construct() {
		...
		if ( ! is_admin() ) {
			$this->logoAreaHeight     = aarhus_select_set_default_logo_height_for_header_types();
	...
	public function loadTemplate( $parameters = array() ) {
		...
		$parameters['logo_area_in_grid'] = aarhus_select_get_meta_field_intersect( 'logo_area_in_grid', $id ) == 'yes' ? true : false;
		$parameters['menu_area_in_grid'] = aarhus_select_get_meta_field_intersect( 'menu_area_in_grid', $id ) == 'yes' ? true : false;
		
		$parameters = apply_filters( 'aarhus_select_filter_header_top_menu_parameters', $parameters );
	...
	public function calculateHeightOfTransparency() {
		...
		$logo_background_color             = aarhus_select_get_meta_field_intersect( 'logo_area_background_color', $id );
		$logo_background_transparency      = aarhus_select_get_meta_field_intersect( 'logo_area_background_transparency', $id );
		$logo_grid_background_color        = aarhus_select_options()->getOptionValue( 'logo_area_grid_background_color' );
		$logo_grid_background_transparency = aarhus_select_options()->getOptionValue( 'logo_area_grid_background_transparency' );
		...
		$menu_background_color             = aarhus_select_get_meta_field_intersect( 'menu_area_background_color', $id );
		$menu_background_transparency      = aarhus_select_get_meta_field_intersect( 'menu_area_background_transparency', $id );
		$menu_grid_background_color        = aarhus_select_options()->getOptionValue( 'menu_area_grid_background_color' );
		$menu_grid_background_transparency = aarhus_select_options()->getOptionValue( 'menu_area_grid_background_transparency' );
		...
		if ( $logoAreaTransparent || $menuAreaTransparent ) {
			if ( $logoAreaTransparent ) {
				...
				if ( ( $sliderExists && aarhus_select_is_top_bar_enabled() )
				     || aarhus_select_is_top_bar_enabled() && aarhus_select_is_top_bar_transparent()
				) {
					$transparencyHeight += aarhus_select_get_top_bar_height();
				}
			}
	...
	public function calculateHeightOfCompleteTransparency() {
		...
		$logo_background_color             = aarhus_select_options()->getOptionValue( 'logo_area_background_color' );
		$logo_background_transparency      = aarhus_select_options()->getOptionValue( 'logo_area_background_transparency' );
		$logo_grid_background_color        = aarhus_select_options()->getOptionValue( 'logo_area_grid_background_color' );
		$logo_grid_background_transparency = aarhus_select_options()->getOptionValue( 'logo_area_grid_background_transparency' );
		...
		$menu_background_color             = aarhus_select_options()->getOptionValue( 'menu_area_background_color' );
		$menu_background_transparency      = aarhus_select_options()->getOptionValue( 'menu_area_background_transparency' );
		$menu_grid_background_color        = aarhus_select_options()->getOptionValue( 'menu_area_grid_background_color' );
		$menu_grid_background_transparency = aarhus_select_options()->getOptionValue( 'menu_area_grid_background_transparency' );
		...
		if ( $logoAreaTransparent || $menuAreaTransparent ) {
			if ( $logoAreaTransparent ) {
				...
				if ( aarhus_select_is_top_bar_enabled() && aarhus_select_is_top_bar_completely_transparent() ) {
					$transparencyHeight += aarhus_select_get_top_bar_height();
				}
			}
	...
	public function calculateHeaderHeight() {
		...
		if ( aarhus_select_is_top_bar_enabled() ) {
			$headerHeight += aarhus_select_get_top_bar_height();
		}
	...
	public function getPerPageJSVariables( $perPageVars ) {
		...
		$header_behavior = aarhus_select_get_meta_field_intersect( 'header_behaviour' );

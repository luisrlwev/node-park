...
if ( ! function_exists( 'aarhus_select_get_hide_dep_for_header_main_menu_options' ) ) {
	function aarhus_select_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'aarhus_select_filter_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'aarhus_select_header_main_navigation_options_map' ) ) {
	function aarhus_select_header_main_navigation_options_map() {
		$hide_dep_options = aarhus_select_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = aarhus_select_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'aarhus' ),
		...
		aarhus_select_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'aarhus' )
			)
		);
		...
		$drop_down_group = aarhus_select_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'aarhus' )
			)
		);
		
		$drop_down_row1 = aarhus_select_add_admin_row(
			array(
		...
		aarhus_select_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'aarhus' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'aarhus' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'aarhus' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'aarhus' )
				)
			)
		);
		...
		$first_level_group = aarhus_select_add_admin_group(
			array(
				...
				'title'       => esc_html__( '1st Level Menu', 'aarhus' ),
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'aarhus' )
			)
		);
		...
		aarhus_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'aarhus' ),
			)
		);
		...
		aarhus_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'aarhus' ),
			)
		);
		
		$first_level_row4 = aarhus_select_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		aarhus_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'aarhus' ),
			)
		);
		...
		aarhus_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'aarhus' ),
			)
		);
		
		$first_level_row5 = aarhus_select_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = aarhus_select_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = aarhus_select_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		aarhus_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'aarhus' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		aarhus_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'aarhus' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = aarhus_select_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'aarhus' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'aarhus' )
			)
		);
		...
		$second_level_wide_group = aarhus_select_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'aarhus' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'aarhus' )
			)
		);
		
		$second_level_wide_row1 = aarhus_select_add_admin_row(
			array(
		...
		$second_level_wide_row2 = aarhus_select_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = aarhus_select_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = aarhus_select_add_admin_group(
			array(
				...
				'title'       => esc_html__( '3nd Level Menu', 'aarhus' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'aarhus' )
			)
		);
		...
		$third_level_wide_group = aarhus_select_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'aarhus' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'aarhus' )
			)
		);
		
		$third_level_wide_row1 = aarhus_select_add_admin_row(
			array(
		...
		$third_level_wide_row2 = aarhus_select_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = aarhus_select_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'aarhus_select_action_header_main_navigation_options_map', 'aarhus_select_header_main_navigation_options_map', 10, 1 );
}
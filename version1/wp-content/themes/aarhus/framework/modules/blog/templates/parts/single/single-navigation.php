<?php
$blog_single_navigation = aarhus_select_options()->getOptionValue('blog_single_navigation') === 'no' ? false : true;
$blog_navigation_through_same_category = aarhus_select_options()->getOptionValue('blog_navigation_through_same_category') === 'no' ? false : true;
?>
			...
			<?php
				...
				$post_navigation = array(
					'prev' => array(
						...
						'label' => '<span class="qodef-blog-single-nav-label">'.esc_html__('previous', 'aarhus').'</span>'
					),
					'next' => array(
						'mark' => '<span class="qodef-blog-single-nav-mark ion-ios-arrow-thin-right"></span>',
						'label' => '<span class="qodef-blog-single-nav-label">'.esc_html__('next', 'aarhus').'</span>'
					)
				);

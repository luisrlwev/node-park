...
$blog_list_image_id  = ! empty( $image_meta ) && aarhus_select_blog_item_has_link() ? aarhus_select_get_attachment_id_from_url( $image_meta ) : '';
?>

<?php if ( $has_featured ) { ?>
	<div class="qodef-post-image">
		<?php if ( aarhus_select_blog_item_has_link() ) { ?>
		...
		<?php } ?>
		<?php do_action('aarhus_select_action_blog_inside_image_tag')?>
	</div>
<?php } ?>
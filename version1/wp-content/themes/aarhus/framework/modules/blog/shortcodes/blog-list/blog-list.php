<?php
namespace AarhusCore\CPT\Shortcodes\BlogList;
...
class BlogList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog List', 'aarhus' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							esc_html__( 'Standard', 'aarhus' ) => 'standard',
							esc_html__( 'Boxed', 'aarhus' )    => 'boxed',
							esc_html__( 'Masonry', 'aarhus' )  => 'masonry',
							esc_html__( 'Simple', 'aarhus' )   => 'simple',
							esc_html__( 'Minimal', 'aarhus' )  => 'minimal',
							esc_html__( 'Hover', 'aarhus' )   => 'hover'
						),
						'save_always' => true
					),
					array(
					...
					array(
						...
						'heading'    => esc_html__( 'Number of Columns', 'aarhus' ),
						'value'      => array_flip( aarhus_select_get_number_of_columns_array( true ) ),
						'dependency' => array( 'element' => 'type', 'value' => array( 'standard', 'boxed', 'masonry', 'hover' ) )
					),
					array(
						'type'        => 'dropdown',
						'param_name'  => 'space_between_items',
						'heading'     => esc_html__( 'Space Between Items', 'aarhus' ),
					...
					array(
						...
						'heading'     => esc_html__( 'Text Length', 'aarhus' ),
						'description' => esc_html__( 'Number of words', 'aarhus' ),
						'dependency'  => Array( 'element' => 'type', 'value'   => array( 'standard', 'boxed', 'masonry', 'simple', 'hover' ) ),
						'group'       => esc_html__( 'Post Info', 'aarhus' )
					),
					array(
						'type'       => 'dropdown',
						'param_name' => 'post_info_image',
						'heading'    => esc_html__( 'Enable Post Info Image', 'aarhus' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Section', 'aarhus' ),
						'value'      => array_flip( aarhus_select_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'type', 'value'   => array( 'standard', 'boxed', 'masonry', 'hover' ) ),
						'group'      => esc_html__( 'Post Info', 'aarhus' )
					),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Share', 'aarhus' ),
						'value'      => array_flip( aarhus_select_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'aarhus' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Read More Button', 'aarhus' ),
						'value'      => array_flip( aarhus_select_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'aarhus' )
					),
					array(
						...
						'heading'    => esc_html__( 'Pagination Type', 'aarhus' ),
						'value'      => array(
							esc_html__( 'None', 'aarhus' )            => 'no-pagination',
							esc_html__( 'Standard', 'aarhus' )        => 'standard-shortcodes',
							esc_html__( 'Load More', 'aarhus' )       => 'load-more',
							esc_html__( 'Infinite Scroll', 'aarhus' ) => 'infinite-scroll'
						),
						'group'      => esc_html__( 'Additional Features', 'aarhus' )
					),
					array(
						'type'       => 'dropdown',
						'param_name' => 'enable_link_over',
						'heading'    => esc_html__( 'Enable Link Over Whole Post', 'aarhus' ),
						'value'      => array_flip( aarhus_select_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'type', 'value' => array( 'boxed', 'hover' ) ),
						'group'      => esc_html__( 'Additional Features', 'aarhus' )
					),
				)
			)
	...
	public function render( $atts, $content = null ) {
		...
		aarhus_select_get_module_template_part( 'shortcodes/blog-list/holder', 'blog', $params['type'], $params );

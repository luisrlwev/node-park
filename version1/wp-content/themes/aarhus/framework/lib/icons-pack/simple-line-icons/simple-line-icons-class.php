...
if ( ! function_exists( 'aarhus_select_add_simple_line_icon_pack' ) ) {
	function aarhus_select_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new AarhusSelectClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'aarhus_select_filter_add_icon_pack_into_collection', 'aarhus_select_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'aarhus_select_add_simple_line_icon_pack_option' ) ) {
	function aarhus_select_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'aarhus' );
		
		return $options;
	}
	
	add_filter( 'aarhus_select_filter_add_icon_pack_into_options', 'aarhus_select_add_simple_line_icon_pack_option' );
	add_filter( 'aarhus_select_filter_add_icon_pack_into_social_options', 'aarhus_select_add_simple_line_icon_pack_option' );
}

class AarhusSelectClassSimpleLineIcons implements iAarhusSelectInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'aarhus'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'aarhus'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'aarhus'),
            'icon-social-facebook'    => esc_html__('Facebook', 'aarhus'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'aarhus'),
            'icon-social-github'      => esc_html__('Github', 'aarhus'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'aarhus'),
            'icon-social-instagram'   => esc_html__('Instagram', 'aarhus'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'aarhus'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'aarhus'),
            'icon-social-reddit'      => esc_html__('Reddit', 'aarhus'),
            'icon-social-skype'       => esc_html__('Skype', 'aarhus'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'aarhus'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'aarhus'),
            'icon-social-spotify'     => esc_html__('Spotify', 'aarhus'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'aarhus'),
            'icon-social-twitter'     => esc_html__('Twitter', 'aarhus'),
            'icon-social-youtube'     => esc_html__('Youtube', 'aarhus')
        );
    }

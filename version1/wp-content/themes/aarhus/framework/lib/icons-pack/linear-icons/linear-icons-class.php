...
if ( ! function_exists( 'aarhus_select_add_linear_icon_pack' ) ) {
	function aarhus_select_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new AarhusSelectClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'aarhus_select_filter_add_icon_pack_into_collection', 'aarhus_select_add_linear_icon_pack' );
}

if ( ! function_exists( 'aarhus_select_add_linear_icon_pack_option' ) ) {
	function aarhus_select_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'aarhus' );
		
		return $options;
	}
	
	add_filter( 'aarhus_select_filter_add_icon_pack_into_options', 'aarhus_select_add_linear_icon_pack_option' );
}

class AarhusSelectClassLinearIcons implements iAarhusSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;

...
if ( ! function_exists( 'aarhus_select_add_font_elegant_icon_pack' ) ) {
	function aarhus_select_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new AarhusSelectClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'aarhus_select_filter_add_icon_pack_into_collection', 'aarhus_select_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'aarhus_select_add_font_elegant_icon_pack_option' ) ) {
	function aarhus_select_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'aarhus' );
		
		return $options;
	}
	
	add_filter( 'aarhus_select_filter_add_icon_pack_into_options', 'aarhus_select_add_font_elegant_icon_pack_option' );
	add_filter( 'aarhus_select_filter_add_icon_pack_into_social_options', 'aarhus_select_add_font_elegant_icon_pack_option' );
}

class AarhusSelectClassIconsFontElegant implements iAarhusSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;

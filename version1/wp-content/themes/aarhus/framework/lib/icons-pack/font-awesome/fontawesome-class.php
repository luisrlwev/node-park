...
if ( ! function_exists( 'aarhus_select_add_font_awesome_icon_pack' ) ) {
	function aarhus_select_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new AarhusSelectClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'aarhus_select_filter_add_icon_pack_into_collection', 'aarhus_select_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'aarhus_select_add_font_awesome_icon_pack_option' ) ) {
	function aarhus_select_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'aarhus' );
		
		return $options;
	}
	
	add_filter( 'aarhus_select_filter_add_icon_pack_into_options', 'aarhus_select_add_font_awesome_icon_pack_option' );
	add_filter( 'aarhus_select_filter_add_icon_pack_into_social_options', 'aarhus_select_add_font_awesome_icon_pack_option' );
}

class AarhusSelectClassIconsFontAwesome implements iAarhusSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	public function getSearchIcon() {
		...
		return $this->render('fas fa-search');
	}

...
if ( ! function_exists( 'aarhus_select_add_linea_icon_pack' ) ) {
	function aarhus_select_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new AarhusSelectClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'aarhus_select_filter_add_icon_pack_into_collection', 'aarhus_select_add_linea_icon_pack' );
}

if ( ! function_exists( 'aarhus_select_add_linea_icon_pack_option' ) ) {
	function aarhus_select_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'aarhus' );
		
		return $options;
	}
	
	add_filter( 'aarhus_select_filter_add_icon_pack_into_options', 'aarhus_select_add_linea_icon_pack_option' );
}

class AarhusSelectClassLineaIcons implements iAarhusSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;

...
if ( ! function_exists( 'aarhus_select_add_dripicons_icon_pack' ) ) {
	function aarhus_select_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new AarhusSelectClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'aarhus_select_filter_add_icon_pack_into_collection', 'aarhus_select_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'aarhus_select_add_dripicons_icon_pack_option' ) ) {
	function aarhus_select_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'aarhus' );
		
		return $options;
	}
	
	add_filter( 'aarhus_select_filter_add_icon_pack_into_options', 'aarhus_select_add_dripicons_icon_pack_option' );
}

class AarhusSelectClassDripicons implements iAarhusSelectInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;

<?php
$qodef_blog_type = aarhus_select_get_archive_blog_list_layout();
aarhus_select_include_blog_helper_functions( 'lists', $qodef_blog_type );
$qodef_holder_params = aarhus_select_get_holder_params_blog();
...
<div class="<?php echo esc_attr( $qodef_holder_params['holder'] ); ?>">
	...
	<div class="<?php echo esc_attr( $qodef_holder_params['inner'] ); ?>">
		<?php aarhus_select_get_blog( $qodef_blog_type ); ?>
	</div>
	
	<?php do_action( 'aarhus_select_action_before_container_close' ); ?>
</div>

<?php do_action( 'aarhus_select_action_blog_list_additional_tags' ); ?>
<?php get_footer(); ?>
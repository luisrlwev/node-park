...
$qodef_row_wrapper_start = $qodef_row_wrapper_end = $row_background_text = $row_background_text_1 = $row_background_text_2 = $row_background_text_size = $row_background_text_color = $row_background_text_size_1440 = $row_background_text_size_1280 = '';
...
if(!empty($row_background_text_1)) {
	...
	$row_background_text .= '<div class="qodef-row-background-text-wrapper-inner" ' . aarhus_select_get_inline_style($row_background_text_styles) . ' ' . esc_html($row_background_text_datas) . '>';
...
if ( $row_content_width === 'grid' ) {
	$qodef_row_wrapper_start .= '<div class="qodef-row-grid-section-wrapper ' . esc_attr( $grid_row_classes ) . '" ' . esc_attr( $grid_row_datas ) . ' ' . aarhus_select_get_inline_style( $qodef_grid_row_styles ) . '><div class="qodef-row-grid-section">';
	$qodef_row_wrapper_end   .= '</div></div>';
}

$qodef_after_wrapper_open   = apply_filters('aarhus_select_filter_vc_after_wrapper_open', '', $atts);
$qodef_before_wrapper_close = apply_filters('aarhus_select_filter_vc_before_wrapper_close', '', $atts);
$css_classes                = apply_filters('aarhus_select_filter_vc_css_classes', $css_classes, $atts);
...
$output .= '<div ' . implode( ' ', $wrapper_attributes ) . ' ' . aarhus_select_get_inline_style( $qodef_vc_row_styles ) . '>';
...
echo aarhus_select_get_module_part($output);

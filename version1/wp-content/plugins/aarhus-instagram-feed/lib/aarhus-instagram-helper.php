...
/**
 * Class AarhusInstagramHelper
 */
class AarhusInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines aarhus_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image, $imageSize ) {
		...
		$imageAtts = apply_filters( 'aarhus_instagram_image_atts',
			array(
				'class'  => $imageSize,

...
include 'aarhus-instagram-helper.php';

/**
 * Class AarhusInstagramApi
 */
class AarhusInstagramApi {
	/**
	...
	private $apiURL;
	/**
	 * @var AarhusInstagramApi instance of current class
	 */
	private static $instance;
	
	/**
	 * Helper object
	 * @var AarhusInstagramHelper
	 */
	private $helper;
	
	const CODE_OPTION_NAME = 'aarhus_instagram_code';
	const USER_ID_OPTION_NAME = 'aarhus_instagram_user_id';
	const ACCESS_TOKEN_OPTION_NAME = 'aarhus_instagram_access_token';
	const CODE_REDIRECT_URI_OPTION_NAME = 'aarhus_instagram_code_redirect_uri';
	...
	public function __construct() {
		...
		$this->helper       = new AarhusInstagramHelper();
	}
	 ...
	 * @return string
	 *
	 * @see AarhusInstagramApi::buildCurrentPageURI()
	 */
	 ...
	 *
	 * @see AarhusInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see AarhusInstagramApi::getAccessToken()
	 */

<?php
namespace AarhusCore\CPT\Shortcodes\ClientsGrid;
...
class ClientsGrid implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if(function_exists('vc_map')) {
			vc_map(
				array(
					'name'      => esc_html__( 'Clients Grid', 'aarhus-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Items Horizontal Alignment', 'aarhus-core' ),
							'value'       => array(
								esc_html__( 'Default Center', 'aarhus-core' ) => '',
						...
						array(
							...
							'heading'     => esc_html__( 'Items Hover Animation', 'aarhus-core' ),
							'value'       => array(
								esc_html__( 'Switch Images', 'aarhus-core' ) => 'switch-images',
								esc_html__( 'Roll Over', 'aarhus-core' )     => 'roll-over'
							),
							'save_always' => true
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = aarhus_core_get_shortcode_module_template_part( 'templates/clients-grid', 'clients-grid', '', $params );

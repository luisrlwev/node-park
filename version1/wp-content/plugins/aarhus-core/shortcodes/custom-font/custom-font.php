...
namespace AarhusCore\CPT\Shortcodes\CustomFont;
...
class CustomFont implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Custom Font', 'aarhus-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'       => 'textfield',
							'param_name' => 'title',
							'heading'    => esc_html__( 'Title Text', 'aarhus-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type_out_effect',
							'heading'     => esc_html__( 'Enable Type Out Effect', 'aarhus-core' ),
							'description' => esc_html__( 'Adds a type out effect inside custom font content', 'aarhus-core' ),
							'value'       => array_flip( aarhus_select_get_yes_no_select_array( false ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'type_out_position',
							'heading'     => esc_html__( 'Position of Type Out Effect', 'aarhus-core' ),
							'description' => esc_html__( 'Enter the position of the word after which you would like to display type out effect (e.g. if you would like the type out effect after the 3rd word, you would enter "3")', 'aarhus-core' ),
							'dependency'  => array( 'element' => 'type_out_effect', 'value' => array( 'yes' ) )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'typed_color',
							'heading'    => esc_html__( 'Typed Color', 'aarhus-core' ),
							'dependency' => array( 'element' => 'type_out_effect', 'value' => array( 'yes' ) )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_1',
							'heading'    => esc_html__( 'Typed Ending Number 1', 'aarhus-core' ),
							'dependency' => Array( 'element' => 'type_out_effect', 'value' => array( 'yes' ) )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_2',
							'heading'    => esc_html__( 'Typed Ending Number 2', 'aarhus-core' ),
							'dependency' => array( 'element' => 'typed_ending_1', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_3',
							'heading'    => esc_html__( 'Typed Ending Number 3', 'aarhus-core' ),
							'dependency' => array( 'element' => 'typed_ending_2', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_4',
							'heading'    => esc_html__( 'Typed Ending Number 4', 'aarhus-core' ),
						...
						array(
							...
							'description' => esc_html__( 'Enter the positions of the words after which you would like to create a line break (e.g. if you would like the line break after the 3rd and 8th words, you would enter "3,8")', 'aarhus-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Font Family', 'aarhus-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'font_size',
							'heading'    => esc_html__( 'Font Size (px or em)', 'aarhus-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'line_height',
							'heading'    => esc_html__( 'Line Height (px or em)', 'aarhus-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'font_weight',
							'heading'     => esc_html__( 'Font Weight', 'aarhus-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Font Style', 'aarhus-core' ),
							'value'       => array_flip( aarhus_select_get_font_style_array( true ) ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'letter_spacing',
							'heading'    => esc_html__( 'Letter Spacing (px or em)', 'aarhus-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'text_transform',
							'heading'     => esc_html__( 'Text Transform', 'aarhus-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Text Decoration', 'aarhus-core' ),
							'value'       => array_flip( aarhus_select_get_text_decorations( true ) ),
							'save_always' => true
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'color',
							'heading'    => esc_html__( 'Color', 'aarhus-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'text_align',
							'heading'     => esc_html__( 'Text Align', 'aarhus-core' ),
							'value'       => array(
								...
								esc_html__( 'Justify', 'aarhus-core' ) => 'justify'
							),
							'save_always' => true
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'margin',
							'heading'     => esc_html__( 'Margin (px or %)', 'aarhus-core' ),
							'description' => esc_html__( 'Insert margin in format: top right bottom left (e.g. 10px 5px 10px 5px)', 'aarhus-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'font_size_1366',
							'heading'    => esc_html__( 'Font Size (px or em)', 'aarhus-core' ),
							'group'      => esc_html__( 'Laptops', 'aarhus-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'aarhus-core' ),
							'group'      => esc_html__( 'Tablets Landscape', 'aarhus-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'aarhus-core' ),
							'group'      => esc_html__( 'Tablets Portrait', 'aarhus-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'aarhus-core' ),
							'group'      => esc_html__( 'Mobiles', 'aarhus-core' )
						),
						array(
							'type'       => 'textfield',
	...
	public function render( $atts, $content = null ) {
		...
		$html = aarhus_core_get_shortcode_module_template_part( 'templates/custom-font', 'custom-font', '', $params );
	...
	private function getHolderStyles( $params ) {
		...
		if ( ! empty( $params['font_size'] ) ) {
			if ( aarhus_select_string_ends_with( $params['font_size'], 'px' ) || aarhus_select_string_ends_with( $params['font_size'], 'em' ) ) {
		...
		if ( ! empty( $params['line_height'] ) ) {
			if ( aarhus_select_string_ends_with( $params['line_height'], 'px' ) || aarhus_select_string_ends_with( $params['line_height'], 'em' ) ) {
		...
		if ( ! empty( $params['letter_spacing'] ) ) {
			if ( aarhus_select_string_ends_with( $params['letter_spacing'], 'px' ) || aarhus_select_string_ends_with( $params['letter_spacing'], 'em' ) ) {
	...
	private function getHolderData( $params ) {
		...
		if ( $params['font_size_1366'] !== '' ) {
			if ( aarhus_select_string_ends_with( $params['font_size_1366'], 'px' ) || aarhus_select_string_ends_with( $params['font_size_1366'], 'em' ) ) {
		...
		if ( $params['font_size_1024'] !== '' ) {
			if ( aarhus_select_string_ends_with( $params['font_size_1024'], 'px' ) || aarhus_select_string_ends_with( $params['font_size_1024'], 'em' ) ) {
		...
		if ( $params['font_size_768'] !== '' ) {
			if ( aarhus_select_string_ends_with( $params['font_size_768'], 'px' ) || aarhus_select_string_ends_with( $params['font_size_768'], 'em' ) ) {
		...
		if ( $params['font_size_680'] !== '' ) {
			if ( aarhus_select_string_ends_with( $params['font_size_680'], 'px' ) || aarhus_select_string_ends_with( $params['font_size_680'], 'em' ) ) {
		...
		if ( $params['line_height_1366'] !== '' ) {
			if ( aarhus_select_string_ends_with( $params['line_height_1366'], 'px' ) || aarhus_select_string_ends_with( $params['line_height_1366'], 'em' ) ) {
		...
		if ( $params['line_height_1024'] !== '' ) {
			if ( aarhus_select_string_ends_with( $params['line_height_1024'], 'px' ) || aarhus_select_string_ends_with( $params['line_height_1024'], 'em' ) ) {
		...
		if ( $params['line_height_768'] !== '' ) {
			if ( aarhus_select_string_ends_with( $params['line_height_768'], 'px' ) || aarhus_select_string_ends_with( $params['line_height_768'], 'em' ) ) {
		...
		if ( $params['line_height_680'] !== '' ) {
			if ( aarhus_select_string_ends_with( $params['line_height_680'], 'px' ) || aarhus_select_string_ends_with( $params['line_height_680'], 'em' ) ) {
	...
	private function getModifiedTitle( $params ) {
		...
		if ( ! empty( $title ) && ( $type_out_effect === 'yes' || ! empty( $title_break_words ) ) ) {
			...
			if ( $type_out_effect === 'yes' && ! empty( $type_out_position ) ) {
				...
				$typed_html = '<span class="qodef-cf-typed-wrap" ' . aarhus_select_get_inline_style( $typed_styles ) . '><span class="qodef-cf-typed">';

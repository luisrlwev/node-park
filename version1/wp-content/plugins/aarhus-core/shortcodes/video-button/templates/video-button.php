...
<div class="qodef-video-button-holder <?php echo esc_attr($holder_classes); ?>">
	...
	<?php } else { ?>
		<a class="qodef-video-button-play" <?php echo aarhus_select_get_inline_style($play_button_styles); ?> href="<?php echo esc_url($video_link); ?>" data-rel="prettyPhoto[video_button_pretty_photo_<?php echo esc_attr($rand); ?>]">
			<span class="qodef-video-button-play-inner">
				<?php echo aarhus_core_return_svg_play_button(); ?>
			</span>
		</a>
	<?php } ?>
</div>
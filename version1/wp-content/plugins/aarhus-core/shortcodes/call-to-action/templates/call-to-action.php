<div class="qodef-call-to-action-holder <?php echo esc_attr($holder_classes); ?>">
	<div class="qodef-cta-inner <?php echo esc_attr($inner_classes); ?>">
		...
		<div class="qodef-cta-button-holder" <?php echo aarhus_select_get_inline_style($button_holder_styles); ?>>
			<div class="qodef-cta-button"><?php echo aarhus_select_get_button_html($button_parameters); ?></div>
		</div>
	</div>
</div>
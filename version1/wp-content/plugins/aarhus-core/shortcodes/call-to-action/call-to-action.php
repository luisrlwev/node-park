<?php
namespace AarhusCore\CPT\Shortcodes\CallToAction;
...
class CallToAction implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Call To Action', 'aarhus-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Set Content In Grid', 'aarhus-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Elements Proportion', 'aarhus-core' ),
							'value'      => array(
								esc_html__( '80/20', 'aarhus-core' ) => '80',
								esc_html__( '75/25', 'aarhus-core' ) => '75',
								esc_html__( '66/33', 'aarhus-core' ) => '66',
								esc_html__( '50/50', 'aarhus-core' ) => '50'
							),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'normal' ) )
						),
						array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Top Margin (px)', 'aarhus-core' ),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'simple' ) ),
							'group'      => esc_html__( 'Button Style', 'aarhus-core' )
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Button Size', 'aarhus-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Color', 'aarhus-core' ),
							'group'      => esc_html__( 'Button Style', 'aarhus-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_hover_color',
							'heading'    => esc_html__( 'Button Hover Color', 'aarhus-core' ),
							'group'      => esc_html__( 'Button Style', 'aarhus-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_background_color',
							'heading'    => esc_html__( 'Button Background Color', 'aarhus-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Hover Background Color', 'aarhus-core' ),
							'group'      => esc_html__( 'Button Style', 'aarhus-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_border_color',
							'heading'    => esc_html__( 'Button Border Color', 'aarhus-core' ),
							'group'      => esc_html__( 'Button Style', 'aarhus-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_hover_border_color',
							'heading'    => esc_html__( 'Button Hover Border Color', 'aarhus-core' ),
							'group'      => esc_html__( 'Button Style', 'aarhus-core' )
						),
						array(
							'type'       => 'textarea_html',
							...
							'value'      => esc_html__( 'I am test text for Call to Action shortcode content', 'aarhus-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = aarhus_core_get_shortcode_module_template_part( 'templates/call-to-action', 'call-to-action', '', $params );
	...
	private function getButtonHolderStyles( $params ) {
		...
		if ( ! empty( $params['button_top_margin'] ) && $params['layout'] === 'simple' ) {
			$styles[] = 'margin-top: ' . aarhus_select_filter_px( $params['button_top_margin'] ) . 'px';
		}

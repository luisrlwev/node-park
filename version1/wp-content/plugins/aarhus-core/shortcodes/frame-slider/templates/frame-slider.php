...
<div class="qodef-frame-slider-holder">
    <div class="qodef-fs-phone">
        <img src="<?php echo AARHUS_CORE_SHORTCODES_URL_PATH ?>/frame-slider/assets/img/frame-slider.png" alt="<?php esc_attr__( 'Frame slider phone', 'aarhus-core' ); ?>">
    </div>
    <div class="qodef-fs-slides qodef-owl-slider" <?php echo aarhus_select_get_inline_attrs( $slider_data ); ?>>

<?php
namespace AarhusCore\CPT\Shortcodes\FrameSlider;
...
class FrameSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Frame Slider', 'aarhus-core' ),
					'base'                      => $this->base,
	...
	public function render( $atts, $content = null ) {
		...
		$html =  aarhus_core_get_shortcode_module_template_part( 'templates/frame-slider', 'frame-slider', '', $params );

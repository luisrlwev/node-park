<?php
namespace AarhusCore\CPT\Shortcodes\ClientsCarouselItem;
...
class ClientsCarouselItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Clients Item', 'aarhus-core' ),
					'base'                    => $this->getBase(),
	...
	public function render( $atts, $content = null ) {
		...
		$html = aarhus_core_get_shortcode_module_template_part( 'templates/clients-carousel-item', 'clients-carousel', '', $params );

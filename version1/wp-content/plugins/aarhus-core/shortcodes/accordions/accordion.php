<?php
namespace AarhusCore\CPT\Shortcodes\Accordion;
...
class Accordion implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Accordion', 'aarhus-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						...
						array(
							...
							'value'      => array(
								esc_html__( 'Accordion', 'aarhus-core' ) => 'accordion',
								esc_html__( 'Toggle', 'aarhus-core' )    => 'toggle'
							)
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'heading'    => esc_html__( 'Background Skin', 'aarhus-core' ),
							'value'      => array(
								esc_html__( 'Default', 'aarhus-core' ) => '',
								esc_html__( 'White', 'aarhus-core' )   => 'white'
							),
	...
	public function render( $atts, $content = null ) {
		...
		$output = aarhus_core_get_shortcode_module_template_part( 'templates/accordion-holder-template', 'accordions', '', $params );

...
class ElementsHolder implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Elements Holder', 'aarhus-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Holder Full Height', 'aarhus-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Columns', 'aarhus-core' ),
							'value'       => array(
								esc_html__( '1 Column', 'aarhus-core' )  => 'one-column',
								esc_html__( '2 Columns', 'aarhus-core' ) => 'two-columns',
								esc_html__( '3 Columns', 'aarhus-core' ) => 'three-columns',
								esc_html__( '4 Columns', 'aarhus-core' ) => 'four-columns',
								esc_html__( '5 Columns', 'aarhus-core' ) => 'five-columns',
								esc_html__( '6 Columns', 'aarhus-core' ) => 'six-columns'
							),
							'save_always' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Items Float Left', 'aarhus-core' ),
						...
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Never', 'aarhus-core' )        => 'never'
							),
						...
						array(
							...
							'heading'     => esc_html__( 'Choose Alignment In Responsive Mode', 'aarhus-core' ),
							'value'       => array(
								esc_html__( 'Default', 'aarhus-core' ) => '',
							...
							'description' => esc_html__( 'Alignment When Items are in One Column', 'aarhus-core' ),
							'save_always' => true
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = '<div ' . aarhus_select_get_class_attribute( $holder_classes ) . ' ' . aarhus_select_get_inline_attr( $holder_styles, 'style' ) . '>';

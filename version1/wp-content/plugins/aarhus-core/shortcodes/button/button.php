<?php
namespace AarhusCore\CPT\Shortcodes\Button;
...
class Button implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Button', 'aarhus-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array_merge(
						array(
							...
							array(
								...
								'value'       => array(
									...
									esc_html__( 'Simple', 'aarhus-core' )  => 'simple'
								),
								'admin_label' => true
							),
							array(
								...
								'value'      => array(
									...
									esc_html__( 'Huge', 'aarhus-core' )    => 'huge'
								),
							...
							array(
								...
								'value'       => esc_html__( 'Button Text', 'aarhus-core' ),
								'save_always' => true,
								'admin_label' => true
							),
							array(
						...
						aarhus_select_icon_collections()->getVCParamsArray( array(), '', true ),
						array(
							array(
								'type'       => 'colorpicker',
								'param_name' => 'color',
								'heading'    => esc_html__( 'Color', 'aarhus-core' ),
								'group'      => esc_html__( 'Design Options', 'aarhus-core' )
							),
							array(
								'type'       => 'colorpicker',
								'param_name' => 'hover_color',
								'heading'    => esc_html__( 'Hover Color', 'aarhus-core' ),
								'group'      => esc_html__( 'Design Options', 'aarhus-core' )
							),
							array(
								'type'       => 'colorpicker',
							...
							array(
								...
								'heading'    => esc_html__( 'Hover Border Color', 'aarhus-core' ),
								'dependency' => array( 'element' => 'type', 'value' => array( 'solid', 'outline' ) ),
								'group'      => esc_html__( 'Design Options', 'aarhus-core' )
							),
							array(
								...
								'heading'    => esc_html__( 'Font Size (px)', 'aarhus-core' ),
								'group'      => esc_html__( 'Design Options', 'aarhus-core' )
							),
							array(
								'type'        => 'dropdown',
							...
							array(
								'type'        => 'textfield',
								'param_name'  => 'padding',
								'heading'     => esc_html__( 'Button Padding', 'aarhus-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		return aarhus_core_get_shortcode_module_template_part( 'templates/' . $params['html_type'], 'button', '', $params );
	}
	...
	private function getButtonStyles( $params ) {
		...
		if ( ! empty( $params['font_size'] ) ) {
			$styles[] = 'font-size: ' . aarhus_select_filter_px( $params['font_size'] ) . 'px';
		}

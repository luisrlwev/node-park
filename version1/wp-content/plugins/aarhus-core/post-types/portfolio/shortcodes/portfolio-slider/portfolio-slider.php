...
class PortfolioSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Slider', 'aarhus-core' ),
					'base'     => $this->base,
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Number of Portfolios Items', 'aarhus-core' ),
							'admin_label' => true,
							'description' => esc_html__( 'Set number of items for your portfolio slider. Enter -1 to show all', 'aarhus-core' )
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'description' => esc_html__( 'Number of portfolios that are showing at the same time in slider (on smaller screens is responsive so there will be less items shown). Default value is Four', 'aarhus-core' ),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'description' => esc_html__( 'Set image proportions for your portfolio slider.', 'aarhus-core' ),
							'save_always' => true
						),
						array(
							'type'        => 'autocomplete',
						...
						array(
							...
							'value'       => array(
								esc_html__( 'Standard - Shader', 'aarhus-core' )                 => 'standard-zoom',
						...
						array(
							...
							'heading'    => esc_html__( 'Navigation Skin', 'aarhus-core' ),
							'value'      => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Pagination Skin', 'aarhus-core' ),
							'value'      => array(
								esc_html__( 'Default', 'aarhus-core' ) => '',
								esc_html__( 'Light', 'aarhus-core' )   => 'light',
								esc_html__( 'Dark', 'aarhus-core' )    => 'dark'
						...
						array(
							...
							'value'       => array(
								esc_html__( 'Below Slider', 'aarhus-core' ) => 'below-slider',
								esc_html__( 'On Slider', 'aarhus-core' )    => 'on-slider'
							),
							'save_always' => true,
							'dependency'  => array( 'element' => 'enable_pagination', 'value' => array( 'yes' ) ),
							'group'       => esc_html__( 'Slider Settings', 'aarhus-core' )

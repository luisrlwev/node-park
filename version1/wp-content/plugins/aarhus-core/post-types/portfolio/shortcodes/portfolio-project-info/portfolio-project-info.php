...
class PortfolioProjectInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Project Info', 'aarhus-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Project', 'aarhus-core' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
							'description' => esc_html__( 'If you left this field empty then project ID will be of the current page', 'aarhus-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'project_info_type',
							'heading'     => esc_html__( 'Project Info Type', 'aarhus-core' ),
							'value'       => array(
								esc_html__( 'Title', 'aarhus-core' )          => 'title',
								esc_html__( 'Category', 'aarhus-core' )       => 'category',
								esc_html__( 'Tag', 'aarhus-core' )            => 'tag',
								esc_html__( 'Author', 'aarhus-core' )         => 'author',
								esc_html__( 'Date', 'aarhus-core' )           => 'date',
								esc_html__( 'Featured Image', 'aarhus-core' ) => 'image'
							),
							'admin_label' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Project Title Tag', 'aarhus-core' ),
							'value'       => array_flip( aarhus_select_get_title_tag( true, array( 'p' => 'p' ) ) ),
							'description' => esc_html__( 'Set title tag for project title element', 'aarhus-core' ),
							'dependency'  => array( 'element' => 'project_info_type', 'value' => array( 'title' ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'project_info_title',
							'heading'     => esc_html__( 'Project Info Label', 'aarhus-core' ),
							'description' => esc_html__( 'Add project info label before project info element/s', 'aarhus-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'project_info_title_tag',
							'heading'    => esc_html__( 'Project Info Label Tag', 'aarhus-core' ),
							'value'      => array_flip( aarhus_select_get_title_tag( true, array( 'p' => 'p' ) ) ),

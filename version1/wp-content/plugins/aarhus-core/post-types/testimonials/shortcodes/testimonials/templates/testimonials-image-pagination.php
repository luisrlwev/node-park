<div class="qodef-testimonials-holder clearfix <?php echo esc_attr( $holder_classes ); ?>">
    <div class="qodef-testimonials qodef-testimonials-image-pagination-inner" <?php echo aarhus_select_get_inline_attrs( $data_attr ) ?>>
    ...
    <ul id="qodef-testimonial-pagination" class="clearfix">
		<?php foreach ( $pagination_images as $image ) : ?>
            <li class="qodef-tsp-item"> <?php print aarhus_select_get_module_part( $image ); ?> </li>
		<?php endforeach; ?>
    </ul>
</div>
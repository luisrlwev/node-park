<div class="qodef-testimonials-holder clearfix <?php echo esc_attr($holder_classes); ?>">
    <div class="qodef-testimonials qodef-owl-slider" <?php echo aarhus_select_get_inline_attrs( $data_attr ) ?>>
        ...
        ?>
                ...
                <div class="qodef-testimonial-content" id="qodef-testimonials-<?php echo esc_attr( $current_id ) ?>" <?php aarhus_select_inline_style( $box_styles ); ?>>

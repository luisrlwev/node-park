<?php
if ( ! function_exists( 'aarhus_select_init_google_fonts_array' ) ) {
    function aarhus_select_init_google_fonts_array() {
        ...
        $aarhus_select_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'aarhus_select_init_google_fonts_array');
}
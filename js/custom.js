	...
	jQuery(document).on('submit', 'form.cons-contact-form', function(e){
		...
		jQuery.ajax({
			...
			success:function(data){
				...
				if(data=="1"){
				jQuery("<div class='alert alert-success'>¡Mesaje enviado exitosamente!</div>").insertBefore('form.cons-contact-form');
				}else{
				jQuery("<div class='alert alert-danger'>Lo sentimos hubo un problema, intente nuevamente por favor</div>").insertBefore('form.cons-contact-form');
				}
			}
		});
